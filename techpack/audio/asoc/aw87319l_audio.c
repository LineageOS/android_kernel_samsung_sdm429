 ...
 * aw87319 marco
 ******************************************************************************/
#define AW87319L_I2C_NAME    "AW87319L_PA"
 ...
 * aw87319 functions
 ******************************************************************************/
unsigned char aw87319l_audio_receiver(void);
unsigned char aw87319l_audio_speaker(void);
unsigned char aw87319l_audio_voice_speaker(void);
unsigned char aw87319l_audio_off(void);
...
static char *aw87319_rcv_name = "aw87319l_rcv.bin";
...
EXPORT_SYMBOL(aw87319l_audio_speaker);
...
EXPORT_SYMBOL(aw87319l_audio_voice_speaker);
...
EXPORT_SYMBOL(aw87319l_audio_off);
...
static int __init aw87319_pa_init(void) {
    int ret;
    pr_info("%s enter\n", __func__);
    pr_info("%s:left driver version: %s\n", __func__, AW87319_DRIVER_VERSION);
