 ...
 * aw87319 marco
 ******************************************************************************/
#define AW87319R_I2C_NAME    "AW87319R_PA"
 ...
 * aw87319 functions
 ******************************************************************************/
unsigned char aw87319r_audio_receiver(void);
unsigned char aw87319r_audio_speaker(void);
unsigned char aw87319r_audio_voice_speaker(void);
unsigned char aw87319r_audio_off(void);
...
static char *aw87319_spk_name = "aw87319r_spk.bin";
static char *aw87319_vspk_name = "aw87319r_vspk.bin";
static char *aw87319_rcv_name = "aw87319r_rcv.bin";
...
static unsigned char aw87319_vspk_reg_val(unsigned char reg)
{
...
EXPORT_SYMBOL(aw87319r_audio_speaker);
...
EXPORT_SYMBOL(aw87319r_audio_voice_speaker);
...
EXPORT_SYMBOL(aw87319r_audio_off);
...
static int __init aw87319_pa_init(void) {
    int ret;
    pr_info("%s enter\n", __func__);
    pr_info("%s:right driver version: %s\n", __func__, AW87319_DRIVER_VERSION);
